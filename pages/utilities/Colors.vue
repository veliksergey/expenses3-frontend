...
<template>
    <div class="card">
        ...
        <p>
            ...
            <i>var</i> syntax such as <i>var(--text-color)</i>.
        </p>
        ...
        <div class="card">
            <table class="w-full">
                ...
                <tbody>
                    <tr>
                        <td class="border-bottom-1 surface-border p-2">
                            <span class="font-medium">--text-color</span>
                        </td>
                        <td class="border-bottom-1 surface-border p-2">Font text color.</td>
                    </tr>
                    <tr>
                        <td class="border-bottom-1 surface-border p-2">
                            <span class="font-medium">--text-color-secondary</span>
                        </td>
                    ...
                    <tr>
                        <td class="border-bottom-1 surface-border p-2">
                            <span class="font-medium">--primary-color-text</span>
                        </td>
                ...
                <div v-for="shade in shades" :key="shade">
                    <div
                        ...
                        :style="{
                            ...
                            color: darkMode ? (shade > 400 ? '#000' : '#fff') : shade > 500 ? '#fff' : '#000'
                        }"
                    >
                        surface-{{ shade }}
                    </div>
